    ...
    <head>
        ...
        <style>
            * { box-sizing: border-box; }
            ...
            .mic-btn { background: #2b2c2d; width: 40px; height: 40px; border-radius: 50%; border: 1px solid #444; font-size: 16px; flex-shrink: 0; }
            .send-btn { background: #ff4444; color: white; border: none; padding: 10px 16px; border-radius: 20px; font-weight: bold; font-size: 14px; cursor: pointer; flex-shrink: 0; }
        </style>
    </head>
    <body>
        <div id="app">
